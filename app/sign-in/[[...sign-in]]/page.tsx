    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-4 py-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-6 md:mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gradient mb-2">Welcome Back</h1>
          <p className="text-sm md:text-base text-gray-400">Sign in to continue learning</p>
        </div>
        <SignIn 
