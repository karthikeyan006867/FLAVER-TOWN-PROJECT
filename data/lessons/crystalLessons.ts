...
export const crystalLessons: Lesson[] = Array.from({ length: 50 }, (_, i) => {
  const difficulty: 'Beginner' | 'Intermediate' | 'Advanced' = i < 17 ? 'Beginner' : i < 34 ? 'Intermediate' : 'Advanced';
  return {
    id: `crystal-${i + 1}`,
    title: `crystal Lesson ${i + 1}`,
    description: `Master crystal programming concepts - Lesson ${i + 1}`,
    language: 'crystal' as const,
    difficulty,
    estimatedTime: 30,
    content: `# crystal Lesson ${i + 1}

Welcome to lesson ${i + 1} of the crystal course!

## Learning Objectives
- Understand core crystal concepts
- Apply programming fundamentals
- Build practical skills

## Practice Exercise
Complete the coding challenge below to test your knowledge.`,
    initialCode: '// Write your crystal code here\n',
