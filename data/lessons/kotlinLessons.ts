...
export const kotlinLessons: Lesson[] = Array.from({ length: 50 }, (_, i) => {
  ...
  return {
    id: `kotlin-${i + 1}`,
    title: `kotlin Lesson ${i + 1}`,
    description: `Master kotlin programming concepts - Lesson ${i + 1}`,
    language: 'kotlin' as const,
    difficulty,
    estimatedTime: 30,
    content: `# kotlin Lesson ${i + 1}

Welcome to lesson ${i + 1} of the kotlin course!
...
Complete the coding challenge below to test your knowledge.`,
    initialCode: '// Write your kotlin code here\n',
