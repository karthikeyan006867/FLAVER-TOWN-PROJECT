...
`,
  ...
  {
    id: 'js-12',
    title: 'JavaScript - Lesson 12',
    description: 'Master JavaScript concepts and techniques - Part 12',
    language: 'javascript' as const,
    difficulty: 'Beginner',
    estimatedTime: 50,
    content: `# JavaScript - Lesson 12
...
## Overview
This lesson covers essential JavaScript concepts for beginner-level developers.
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 12
...
`,
    initialCode: `// JavaScript Lesson 12
// Write your code here
...
`,
    hints: [
      ...
      'Refer to JavaScript documentation for details'
    ],
    testCases: [
      { 
      ...
      { 
        ...
        errorMessage: 'Make sure your code follows JavaScript syntax' 
      }
    ]
  },
  {
    id: 'js-13',
    title: 'JavaScript - Lesson 13',
    description: 'Master JavaScript concepts and techniques - Part 13',
    language: 'javascript' as const,
    difficulty: 'Beginner',
    estimatedTime: 20,
    content: `# JavaScript - Lesson 13
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 13
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 13
// Write your code here
...
`,
  ...
  {
    id: 'js-14',
    title: 'JavaScript - Lesson 14',
    description: 'Master JavaScript concepts and techniques - Part 14',
    language: 'javascript' as const,
    difficulty: 'Beginner',
    estimatedTime: 30,
    content: `# JavaScript - Lesson 14
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 14
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 14
// Write your code here
...
`,
  ...
  {
    id: 'js-15',
    title: 'JavaScript - Lesson 15',
    description: 'Master JavaScript concepts and techniques - Part 15',
    language: 'javascript' as const,
    difficulty: 'Beginner',
    estimatedTime: 40,
    content: `# JavaScript - Lesson 15
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 15
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 15
// Write your code here
...
`,
  ...
  {
    id: 'js-16',
    title: 'JavaScript - Lesson 16',
    description: 'Master JavaScript concepts and techniques - Part 16',
    language: 'javascript' as const,
    difficulty: 'Beginner',
    estimatedTime: 50,
    content: `# JavaScript - Lesson 16
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 16
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 16
// Write your code here
...
`,
  ...
  {
    id: 'js-17',
    title: 'JavaScript - Lesson 17',
    description: 'Master JavaScript concepts and techniques - Part 17',
    language: 'javascript' as const,
    difficulty: 'Beginner',
    estimatedTime: 20,
    content: `# JavaScript - Lesson 17
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 17
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 17
// Write your code here
...
`,
  ...
  {
    id: 'js-18',
    title: 'JavaScript - Lesson 18',
    description: 'Master JavaScript concepts and techniques - Part 18',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 30,
    content: `# JavaScript - Lesson 18
...
## Overview
This lesson covers essential JavaScript concepts for intermediate-level developers.
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 18
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 18
// Write your code here
...
`,
  ...
  {
    id: 'js-19',
    title: 'JavaScript - Lesson 19',
    description: 'Master JavaScript concepts and techniques - Part 19',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 40,
    content: `# JavaScript - Lesson 19
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 19
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 19
// Write your code here
...
`,
  ...
  {
    id: 'js-20',
    title: 'JavaScript - Lesson 20',
    description: 'Master JavaScript concepts and techniques - Part 20',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 50,
    content: `# JavaScript - Lesson 20
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 20
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 20
// Write your code here
...
`,
  ...
  {
    id: 'js-21',
    title: 'JavaScript - Lesson 21',
    description: 'Master JavaScript concepts and techniques - Part 21',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 20,
    content: `# JavaScript - Lesson 21
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 21
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 21
// Write your code here
...
`,
  ...
  {
    id: 'js-22',
    title: 'JavaScript - Lesson 22',
    description: 'Master JavaScript concepts and techniques - Part 22',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 30,
    content: `# JavaScript - Lesson 22
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 22
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 22
// Write your code here
...
`,
  ...
  {
    id: 'js-23',
    title: 'JavaScript - Lesson 23',
    description: 'Master JavaScript concepts and techniques - Part 23',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 40,
    content: `# JavaScript - Lesson 23
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 23
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 23
// Write your code here
...
`,
  ...
  {
    id: 'js-24',
    title: 'JavaScript - Lesson 24',
    description: 'Master JavaScript concepts and techniques - Part 24',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 50,
    content: `# JavaScript - Lesson 24
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 24
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 24
// Write your code here
...
`,
  ...
  {
    id: 'js-25',
    title: 'JavaScript - Lesson 25',
    description: 'Master JavaScript concepts and techniques - Part 25',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 20,
    content: `# JavaScript - Lesson 25
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 25
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 25
// Write your code here
...
`,
  ...
  {
    id: 'js-26',
    title: 'JavaScript - Lesson 26',
    description: 'Master JavaScript concepts and techniques - Part 26',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 30,
    content: `# JavaScript - Lesson 26
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 26
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 26
// Write your code here
...
`,
  ...
  {
    id: 'js-27',
    title: 'JavaScript - Lesson 27',
    description: 'Master JavaScript concepts and techniques - Part 27',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 40,
    content: `# JavaScript - Lesson 27
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 27
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 27
// Write your code here
...
`,
  ...
  {
    id: 'js-28',
    title: 'JavaScript - Lesson 28',
    description: 'Master JavaScript concepts and techniques - Part 28',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 50,
    content: `# JavaScript - Lesson 28
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 28
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 28
// Write your code here
...
`,
  ...
  {
    id: 'js-29',
    title: 'JavaScript - Lesson 29',
    description: 'Master JavaScript concepts and techniques - Part 29',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 20,
    content: `# JavaScript - Lesson 29
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 29
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 29
// Write your code here
...
`,
  ...
  {
    id: 'js-30',
    title: 'JavaScript - Lesson 30',
    description: 'Master JavaScript concepts and techniques - Part 30',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 30,
    content: `# JavaScript - Lesson 30
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 30
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 30
// Write your code here
...
`,
  ...
  {
    id: 'js-31',
    title: 'JavaScript - Lesson 31',
    description: 'Master JavaScript concepts and techniques - Part 31',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 40,
    content: `# JavaScript - Lesson 31
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 31
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 31
// Write your code here
...
`,
  ...
  {
    id: 'js-32',
    title: 'JavaScript - Lesson 32',
    description: 'Master JavaScript concepts and techniques - Part 32',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 50,
    content: `# JavaScript - Lesson 32
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 32
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 32
// Write your code here
...
`,
  ...
  {
    id: 'js-33',
    title: 'JavaScript - Lesson 33',
    description: 'Master JavaScript concepts and techniques - Part 33',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 20,
    content: `# JavaScript - Lesson 33
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 33
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 33
// Write your code here
...
`,
  ...
  {
    id: 'js-34',
    title: 'JavaScript - Lesson 34',
    description: 'Master JavaScript concepts and techniques - Part 34',
    language: 'javascript' as const,
    difficulty: 'Intermediate',
    estimatedTime: 30,
    content: `# JavaScript - Lesson 34
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 34
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 34
// Write your code here
...
`,
  ...
  {
    id: 'js-35',
    title: 'JavaScript - Lesson 35',
    description: 'Master JavaScript concepts and techniques - Part 35',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 40,
    content: `# JavaScript - Lesson 35
...
## Overview
This lesson covers essential JavaScript concepts for advanced-level developers.
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 35
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 35
// Write your code here
...
`,
  ...
  {
    id: 'js-36',
    title: 'JavaScript - Lesson 36',
    description: 'Master JavaScript concepts and techniques - Part 36',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 50,
    content: `# JavaScript - Lesson 36
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 36
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 36
// Write your code here
...
`,
  ...
  {
    id: 'js-37',
    title: 'JavaScript - Lesson 37',
    description: 'Master JavaScript concepts and techniques - Part 37',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 20,
    content: `# JavaScript - Lesson 37
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 37
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 37
// Write your code here
...
`,
  ...
  {
    id: 'js-38',
    title: 'JavaScript - Lesson 38',
    description: 'Master JavaScript concepts and techniques - Part 38',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 30,
    content: `# JavaScript - Lesson 38
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 38
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 38
// Write your code here
...
`,
  ...
  {
    id: 'js-39',
    title: 'JavaScript - Lesson 39',
    description: 'Master JavaScript concepts and techniques - Part 39',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 40,
    content: `# JavaScript - Lesson 39
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 39
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 39
// Write your code here
...
`,
  ...
  {
    id: 'js-40',
    title: 'JavaScript - Lesson 40',
    description: 'Master JavaScript concepts and techniques - Part 40',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 50,
    content: `# JavaScript - Lesson 40
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 40
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 40
// Write your code here
...
`,
  ...
  {
    id: 'js-41',
    title: 'JavaScript - Lesson 41',
    description: 'Master JavaScript concepts and techniques - Part 41',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 20,
    content: `# JavaScript - Lesson 41
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 41
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 41
// Write your code here
...
`,
  ...
  {
    id: 'js-42',
    title: 'JavaScript - Lesson 42',
    description: 'Master JavaScript concepts and techniques - Part 42',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 30,
    content: `# JavaScript - Lesson 42
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 42
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 42
// Write your code here
...
`,
  ...
  {
    id: 'js-43',
    title: 'JavaScript - Lesson 43',
    description: 'Master JavaScript concepts and techniques - Part 43',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 40,
    content: `# JavaScript - Lesson 43
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 43
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 43
// Write your code here
...
`,
  ...
  {
    id: 'js-44',
    title: 'JavaScript - Lesson 44',
    description: 'Master JavaScript concepts and techniques - Part 44',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 50,
    content: `# JavaScript - Lesson 44
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 44
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 44
// Write your code here
...
`,
  ...
  {
    id: 'js-45',
    title: 'JavaScript - Lesson 45',
    description: 'Master JavaScript concepts and techniques - Part 45',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 20,
    content: `# JavaScript - Lesson 45
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 45
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 45
// Write your code here
...
`,
  ...
  {
    id: 'js-46',
    title: 'JavaScript - Lesson 46',
    description: 'Master JavaScript concepts and techniques - Part 46',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 30,
    content: `# JavaScript - Lesson 46
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 46
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 46
// Write your code here
...
`,
  ...
  {
    id: 'js-47',
    title: 'JavaScript - Lesson 47',
    description: 'Master JavaScript concepts and techniques - Part 47',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 40,
    content: `# JavaScript - Lesson 47
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 47
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 47
// Write your code here
...
`,
  ...
  {
    id: 'js-48',
    title: 'JavaScript - Lesson 48',
    description: 'Master JavaScript concepts and techniques - Part 48',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 50,
    content: `# JavaScript - Lesson 48
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 48
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 48
// Write your code here
...
`,
  ...
  {
    id: 'js-49',
    title: 'JavaScript - Lesson 49',
    description: 'Master JavaScript concepts and techniques - Part 49',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 20,
    content: `# JavaScript - Lesson 49
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 49
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 49
// Write your code here
...
`,
  ...
  {
    id: 'js-50',
    title: 'JavaScript - Lesson 50',
    description: 'Master JavaScript concepts and techniques - Part 50',
    language: 'javascript' as const,
    difficulty: 'Advanced',
    estimatedTime: 30,
    content: `# JavaScript - Lesson 50
...
## Code Example
\`\`\`javascript
// JavaScript example for lesson 50
// Add your implementation here
\`\`\`
...
- Test your code thoroughly
`,
    initialCode: `// JavaScript Lesson 50
// Write your code here
