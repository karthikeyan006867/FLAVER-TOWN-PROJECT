...
export const juliaLessons: Lesson[] = Array.from({ length: 50 }, (_, i) => {
  const difficulty: 'Beginner' | 'Intermediate' | 'Advanced' = i < 17 ? 'Beginner' : i < 34 ? 'Intermediate' : 'Advanced';
  return {
    id: `julia-${i + 1}`,
    title: `julia Lesson ${i + 1}`,
    description: `Master julia programming concepts - Lesson ${i + 1}`,
    language: 'julia' as const,
    difficulty,
    estimatedTime: 30,
    content: `# julia Lesson ${i + 1}

Welcome to lesson ${i + 1} of the julia course!

## Learning Objectives
- Understand core julia concepts
- Apply programming fundamentals
- Build practical skills

## Practice Exercise
Complete the coding challenge below to test your knowledge.`,
    initialCode: '// Write your julia code here\n',
