...
export const elixirLessons: Lesson[] = Array.from({ length: 50 }, (_, i) => {
  const difficulty: 'Beginner' | 'Intermediate' | 'Advanced' = i < 17 ? 'Beginner' : i < 34 ? 'Intermediate' : 'Advanced';
  return {
    id: `elixir-${i + 1}`,
    title: `elixir Lesson ${i + 1}`,
    description: `Master elixir programming concepts - Lesson ${i + 1}`,
    language: 'elixir' as const,
    difficulty,
    estimatedTime: 30,
    content: `# elixir Lesson ${i + 1}

Welcome to lesson ${i + 1} of the elixir course!

## Learning Objectives
- Understand core elixir concepts
- Apply programming fundamentals
- Build practical skills

## Practice Exercise
Complete the coding challenge below to test your knowledge.`,
    initialCode: '// Write your elixir code here\n',
